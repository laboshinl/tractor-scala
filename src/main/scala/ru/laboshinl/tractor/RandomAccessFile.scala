...
class RandomAccessFile(file: File, arg0: String = "r")(implicit converter: ByteConverter = ByteConverterBigEndian)
  ...
  /** Alias, in java style, for [[ru.laboshinl.tractor.RandomAccessFile.readInt8]]
    */
  @throws(classOf[IOException])
  ...
  /** Alias, in java style, for [[ru.laboshinl.tractor.RandomAccessFile.writeInt8]]
    */
  @throws(classOf[IOException])
  ...
  /** Alias, in java style, for [[ru.laboshinl.tractor.RandomAccessFile.readUInt8]]
    */
  @throws(classOf[IOException])
  ...
  /** Alias, in java style, for [[ru.laboshinl.tractor.RandomAccessFile.writeUInt8]]
    */
  @throws(classOf[IOException])
  ...
  /** Alias, in java style, for [[ru.laboshinl.tractor.RandomAccessFile.readInt16]]
    */
  @throws(classOf[IOException])
  ...
  @throws(classOf[IOException])
  def readBUInt16(): Char = {
    val ba = readByte(2)
    ByteConverterBigEndian.bytesToUInt16(ba(0), ba(1))
  }

  @throws(classOf[IOException])
  def readBInt16(): Short = {
    val ba = readByte(2)
    ByteConverterBigEndian.bytesToInt16(ba(0), ba(1))
    //converter.bytesToUInt16(ba(0), ba(1))
  }
  ...
  def readBInt32(): Int = {
    val ba = readByte(4)
    ByteConverterBigEndian.bytesToInt32(ba(0),ba(1),ba(2),ba(3))
    //converter.bytesToUInt16(ba(0), ba(1))
  }

  @throws(classOf[IOException])
  def readUnsignedBInt32(): Long = {
    val ba = readByte(4)
    ByteConverterBigEndian.bytesToInt32(ba(0),ba(1),ba(2),ba(3)) & 0xffffffffl
    //converter.bytesToUInt16(ba(0), ba(1))
  }
  ...
  /** Alias, in java style, for [[ru.laboshinl.tractor.RandomAccessFile.readUInt16]], but reads as Int.
    */
  @throws(classOf[IOException])
  final override def readUnsignedShort(): Int = readUInt16().toInt

  @throws(classOf[IOException])
  final def readUnsignedBShort(): Int = readBUInt16().toInt
  ...
  /** Alias, in java style, for [[ru.laboshinl.tractor.RandomAccessFile.readUInt16]]
    */
  @throws(classOf[IOException])
  ...
  /** Alias, in java style, for [[ru.laboshinl.tractor.RandomAccessFile.writeUInt16]], but reads as Int.
    */
  @throws(classOf[IOException])
  ...
  /** Alias, in java style, for [[ru.laboshinl.tractor.RandomAccessFile.writeUInt16]]
    */
  @throws(classOf[IOException])
  ...
  /** Alias, in java style, for [[ru.laboshinl.tractor.RandomAccessFile.readUInt32]]
    */
  @throws(classOf[IOException])
  ...
  /** Alias, in java style, for [[ru.laboshinl.tractor.RandomAccessFile.writeInt32]]
    */
  @throws(classOf[IOException])
  ...
  /** Alias, in java style, for [[ru.laboshinl.tractor.RandomAccessFile.readInt64]]
    */
  @throws(classOf[IOException])
  ...
  /** Alias, in java style, for [[ru.laboshinl.tractor.RandomAccessFile.writeInt64]]
    */
  @throws(classOf[IOException])
...
abstract class ByteConverter {
  ...
  /**Takes an Int64 (Long), and returns an array of 8 bytes, shifted up to a UInt64.
    * See [[ru.laboshinl.tractor.ByteConverter.bytesToUInt64Shifted()]]*/
  def uInt64ShiftedToBytes(value: Long): Array[Byte]

}

/** See [[ru.laboshinl.tractor.ByteConverter]], reads big endian.
  */
...
/** See [[ru.laboshinl.tractor.ByteConverter]], reads little endian.
  */
